...
const MAINNET_RPC = process.env.VITE_APP_SOLANA_MAINNET_RPC;
const TESTNET_RPC = process.env.VITE_APP_SOLANA_TESTNET_RPC;
const DEVNET_RPC = process.env.VITE_APP_SOLANA_DEVNET_RPC;
